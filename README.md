...
# Hood.de plugin for plentymarkets 7.x

This is the Hood.de plugin developed by plentymarkets. Hood.de is already integrated in your plentymarkets 7 system.
